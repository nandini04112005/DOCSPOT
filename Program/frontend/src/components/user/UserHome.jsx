...
const UserHome = () => {
   ...
   // Add effect to refresh data when activeMenuItem changes to userappointments
   useEffect(() => {
      if (activeMenuItem === 'userappointments') {
         // Refresh user data when viewing appointments to get updated status
         getUserData();
      }
   }, [activeMenuItem, getUserData]);
