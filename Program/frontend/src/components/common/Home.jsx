    ...
    <>
      ...
      <div className='home-container'>
        ...
        <div className="right-side">
          <p>
            <span className='f-letter'>"Seamless doctor appointments".</span><br />
            <span className='s-letter'> Right at your fingertips,</span> <br />
            <span className='t-letter'>Your health journey, simplified.</span><br />
